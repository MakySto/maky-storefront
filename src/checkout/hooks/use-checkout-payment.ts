...
// Adopted from upstream use-checkout-payment; MAKY adaptation: navigateToOrderConfirmation
// comes from @/checkout/lib/navigate-to-order (B.4.3 file, no lib/payment/navigate-to-order).
