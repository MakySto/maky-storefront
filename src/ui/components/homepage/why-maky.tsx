	...
	return (
		...
		>
			<path
				strokeLinecap="round"
				strokeLinejoin="round"
				d="M11.42 15.17l-5.1 5.1a2.121 2.121 0 01-3-3l5.1-5.1m0 0L15 4.5a5.25 5.25 0 017.5 7.5l-7.58 7.58m-4.92-4.91l4.92 4.91"
			/>
		</svg>
	);
}
	...
	return (
		...
		>
			<path
				strokeLinecap="round"
				strokeLinejoin="round"
				d="M2.25 6.75a9 9 0 0119.5 0v1.5a.75.75 0 01-.75.75h-.75a3 3 0 00-3 3v1.5a3 3 0 003 3h.75a.75.75 0 01.75.75V18a3.75 3.75 0 01-3.75 3.75h-3a.75.75 0 01-.75-.75v-.75a.75.75 0 00-.75-.75h-1.5a.75.75 0 00-.75.75v.75a.75.75 0 01-.75.75h0A5.25 5.25 0 012.25 16.5V6.75z"
			/>
		</svg>
	);
}
