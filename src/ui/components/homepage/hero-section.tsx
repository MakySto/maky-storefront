      ...
      <div className="mx-auto max-w-7xl px-6 py-20 sm:py-28 lg:px-8 lg:py-32">
        <div className="max-w-2xl">
          ...
          <h1 className="mt-4 text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
            {t("roofRacks")}, {t("roofBoxes")},{" "}
            {t("towBars")}
          </h1>
          <p className="mt-6 text-lg leading-8 text-gray-300">
            {"13 "}
            {tc("country") === "Slovensko" ? "európskych trhov" : "European markets"}
            {" · 4 "}
            {tc("country") === "Slovensko" ? "dodávatelia" : "suppliers"}
            {" · 7 000+ "}
            {tc("country") === "Slovensko" ? "produktov" : "products"}
          </p>
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:items-center">
            ...
            <a href="#categories" className="inline-flex items-center gap-1 text-sm font-medium text-gray-300 transition hover:text-white">
              {t("allCategories")}
              <ArrowIcon />
            </a>
          </div>
