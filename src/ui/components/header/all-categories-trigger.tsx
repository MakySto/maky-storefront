...
export function AllCategoriesTrigger() {
  ...
  return (
    <button
      ...
      className="inline-flex h-10 items-center gap-2 rounded-sm bg-copper-600 px-4 text-[0.9375rem] font-semibold text-white transition-colors hover:bg-copper-700"
    >
