	...
	return (
		<div className={`flex min-w-0 items-center gap-2 sm:gap-3 ${className ?? ""}`}>
			...
			<div className="flex min-w-0 flex-col">
				<span
					className={`truncate text-base leading-tight font-bold tracking-tight sm:text-xl lg:text-[1.375rem] ${
				...
				{showSlogan && slogan && (
					...
					<span
						...
						className={`truncate text-[0.625rem] leading-tight font-medium tracking-tight sm:text-[0.6875rem] sm:tracking-wide lg:text-xs ${
