...
export function ImageLightbox({
  ...
  return createPortal(
    <div
      className="fixed inset-0 z-[1200] bg-black/92 backdrop-blur-md"
      onClick={onClose}
      role="dialog"
      aria-modal="true"
      aria-label={productName}
    >
      <div className="mx-auto flex h-full w-full max-w-[1600px] flex-col px-3 pb-3 pt-3 sm:px-6 sm:pb-6 sm:pt-6">
        {/* Top bar */}
        <div
          ...
          {hasMultiple && (
            <div className="pointer-events-none absolute inset-y-0 left-0 right-0 z-10 hidden md:block">
              <button
                ...
                className="pointer-events-auto absolute left-0 top-1/2 -translate-y-1/2 rounded-xl border border-white/10 bg-white/10 p-3 text-white backdrop-blur-sm transition-colors hover:bg-white/20"
              ...
              <button
                ...
                className="pointer-events-auto absolute right-0 top-1/2 -translate-y-1/2 rounded-xl border border-white/10 bg-white/10 p-3 text-white backdrop-blur-sm transition-colors hover:bg-white/20"
              ...
              {images.map((img, index) => (
                <button
                  ...
                  className={cn(
                    ...
                    currentIndex === index
                      ? "border-white/80 shadow-md shadow-black/30 ring-1 ring-white/60"
